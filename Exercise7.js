...
const tax = subtotal * .10 //calculate the tax on the bill assuming a 10% tax rate
const tip = subtotal * .20 //calculate what a 20% tip on the bill would be

// I would of done tip = (subtotal + tax) * .20 
