...
People aged 17 and up can see any movie; people aged 13-16 can see PG-13, PG, or G movies, and everyone else can only see PG or G movies. */
...
if (age >= 17) {
    ...
    console.log("You are only old enough to watch PG-13, PG and G movies")
} else {
